...
import com.example.myapplication.ui.theme.HaulaufBackground
...
private val DarkColorScheme = darkColorScheme(
    primary = HaulaufGoldLight,
    onPrimary = Color(0xFF000000),
    secondary = HaulaufGold,
    onSecondary = Color(0xFF000000),
    tertiary = Pink80,
    background = HaulaufBackground,
    surface = HaulaufBackground,
    onBackground = Color(0xFFFFFFFF),
    onSurface = Color(0xFFFFFFFF),
    onSurfaceVariant = HaulaufTextSecondary,
    outline = HaulaufCardBorder
)
